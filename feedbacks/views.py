...
def feedback(request):
    ...
    if request.method == 'POST':
        ...
        print(feedback_content, 'feedback score:', feedback_score, feedback_owner, feedback_manuscript)

        if feedback_score == None:
            return render(request, 'feedbacks/feedback.html', {'error': 'Give a rating or Proceed without feedback'})
        else:
            f = Feedback()
